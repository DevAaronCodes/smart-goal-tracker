...
function App() {
  ...
  return <div className="min-h-screen">
    ...
    <main className="mx-auto max-w-7xl px-4 py-7 sm:px-6 sm:py-10">{page === 'dashboard' && <Dashboard goals={data.goals} activities={data.activities} onLog={setLogging} onEdit={setEditing} onStartWeek={startNewWeek} onStartAllWeeks={startAllWeeks} onDelete={deleteGoal} />}{page === 'history' && <HistoryPage goals={data.goals} activities={data.activities} />}{page === 'export' && <ExportPage goals={data.goals} activities={data.activities} onImport={loadTemplate} />}</main>
